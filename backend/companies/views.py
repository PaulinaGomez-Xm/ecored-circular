...
class CompanyViewSet(viewsets.ViewSet):
    # Exige autenticacion para acceder a este conjunto de endpoints.
    ...
    def create(self, request):
        ...
        # Construye el documento que sera almacenado en MongoDB.
        document = {
            "owner_uid": uid,
            "name": data.get("name"),
            "nit": data.get("nit"),
...
class MaterialListingViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        # Construye el documento de publicacion.
        document = {
        ...
        # Inserta la publicacion en la coleccion.
...
def health(request):
    # Endpoint minimo para verificar que el backend esta respondiendo.
